...
- `packages/recozik-web/src/recozik_web/`: FastAPI backend module that reuses `recozik-services` and exposes HTTP endpoints with token-based auth/quota enforcement for future GUIs.
