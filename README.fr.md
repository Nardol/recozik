...
- `--audd-mode standard|enterprise|auto` choisit l'endpoint AudD à utiliser (le mode `auto` bascule vers l'entreprise si le fichier est trop gros ou si des paramètres enterprise sont activés).
